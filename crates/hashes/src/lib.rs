...
impl_hash!(BeltHash,              32, belt_hash::BeltHash,       rust_crypto_hash_with_digest, belt_hash::Digest, );
impl_hash!(Blake2b,               64, blake2::Blake2b512,        rust_crypto_hash_with_digest, blake2::Digest,    );
impl_hash!(Blake2s,               32, blake2::Blake2s256,        rust_crypto_hash_with_digest, blake2::Digest,    );
impl_hash!(Blake3,                32, blake3::Hasher,            rust_crypto_hash_with_digest, digest::Digest,    );
impl_hash!(Fsb256,                32, fsb::Fsb256,               rust_crypto_hash_with_digest, fsb::Digest,       );
impl_hash!(Fsb512,                64, fsb::Fsb512,               rust_crypto_hash_with_digest, fsb::Digest,       );
impl_hash!(Groestl256,            32, groestl::Groestl256,       rust_crypto_hash_with_digest, groestl::Digest,   );
impl_hash!(Groestl512,            64, groestl::Groestl512,       rust_crypto_hash_with_digest, groestl::Digest,   );
impl_hash!(Md5,                   16, md5::Md5,                  rust_crypto_hash_with_digest, md5::Digest,       );
impl_hash!(Ripemd160,             20, ripemd::Ripemd160,         rust_crypto_hash_with_digest, ripemd::Digest,    );
impl_hash!(Sha256,                32, sha2::Sha256,              rust_crypto_hash_with_digest, sha2::Digest,      );
impl_hash!(Sha3_256,              32, sha3::Sha3_256,            rust_crypto_hash_with_digest, sha3::Digest,      );
impl_hash!(Sha3_512,              64, sha3::Sha3_512,            rust_crypto_hash_with_digest, sha3::Digest,      );
impl_hash!(Sha512,                64, sha2::Sha512,              rust_crypto_hash_with_digest, sha2::Digest,      );
impl_hash!(Shabal512,             64, shabal::Shabal512,         rust_crypto_hash_with_digest, shabal::Digest,    );
impl_hash!(Sm3,                   32, sm3::Sm3,                  rust_crypto_hash_with_digest, sm3::Digest,       );
impl_hash!(Tiger,                 24, tiger::Tiger,              rust_crypto_hash_with_digest, tiger::Digest,     );
impl_hash!(Tiger2,                24, tiger::Tiger2,             rust_crypto_hash_with_digest, tiger::Digest,     );
impl_hash!(Whirlpool,             64, whirlpool::Whirlpool,      rust_crypto_hash_with_digest, whirlpool::Digest, );
impl_hash!(KangarooTwelve256<'a>, 32, k12::KangarooTwelve<'a>,   rust_crypto_hash_extendable,  digest::Update,    digest::ExtendableOutput, );
impl_hash!(KangarooTwelve512<'a>, 64, k12::KangarooTwelve<'a>,   rust_crypto_hash_extendable,  digest::Update,    digest::ExtendableOutput, );
...
impl_hash!(MetroHash128,          8,  metrohash::MetroHash128,   std_hasher_per_byte,          );
